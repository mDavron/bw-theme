...
add_theme_support( 'custom-logo');
  ...
  function add_scripts_and_styles(){
    ...
    wp_enqueue_script( 'swiper', get_template_directory_uri() . '/assets/js/swiper-bundle.min.js',false, null, 'footer' );
    wp_enqueue_script( 'main', get_template_directory_uri() . '/assets/js/main.js', array('jquery','swiper'), null, 'footer' );
